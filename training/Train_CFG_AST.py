...
def filter_csv(csv_file_path):
    ...
    with open(csv_file_path, 'r') as file:
        ...
        for row in csv_reader:
            ...
            modified_file_path = file_path[:-5] + "-Comb1.json"  # Modify the file path
...
# Example usage
csv_file_path = "dataset_AST_CFG.csv"  # Replace with your CSV file path
...
csv_file_path = "dataset_AST_CFG.csv"
issues = []
file_paths = []
y_values = []
...
for i, file_path in enumerate(file_paths):
    ...
    json_file_path = file_path_without_extension + "-Comb1.json"
...
torch.save(Bmodel.state_dict(), "Model_AST_CFG.pth")
...
def calculate_map_mrr(Bmodel, tokenizer, issues, file_paths, y_values):
    ...
    for idx, issue_text in enumerate(unique_issues):
        ...
        predicted_files, predicted_probabilities = predict_top_files_for_issue(Bmodel, tokenizer, issue_text, file_paths, top_n=5)
