...
def filter_csv(csv_file_path):
    ...
    with open(csv_file_path, 'r') as file:
        ...
        for row in csv_reader:
            ...
            modified_file_path = file_path[:-5] + "-CFG.json"  # Modify the file path
...
# Example usage
csv_file_path = "dataset.csv"  # Replace with your CSV file path
...
for i, file_path in enumerate(file_paths):
    ...
    json_file_path = file_path_without_extension + "-CFG.json"
...
torch.save(Bmodel.state_dict(), "Model_CFG.pth")
